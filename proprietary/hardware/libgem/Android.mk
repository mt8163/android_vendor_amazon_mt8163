...
#
# libui_ext.so in vendor partition
#
...
#
# libui_ext.so in system partition
#

include $(CLEAR_VARS)

LOCAL_MODULE := libui_ext_fwk
...
#
# libged_kpi (wrapper for ged_kpi in libged)
#
include $(CLEAR_VARS)

LOCAL_CFLAGS := -DLOG_TAG=\"GED_KPI_WRAP\"
...
LOCAL_C_INCLUDES:= \
	...
	$(TOP)/$(MTK_PATH_SOURCE)/hardware/gpu_ext/ged/include
