...
#define LOG_REMARK_HW_ERROR_STR "<hw error>" /* can be changed */
...
#define HW_ISP_REG_CMP(CMD, a, b, c, d, e) \
  ...
  CMD(a, b, c, d, e, top.dbs_en, true, 0x15004004, 0x01000000, 24, CAM_CTL_EN_P1, DBS_EN)\
  ...
  CMD(a, b, c, d, e, top.nsl2a_en, true, 0x15004018, 0x80000000, 31, CAM_CTL_EN_P2, NSL2A_EN)\
  ...
  CMD(a, b, c, d, e, bnr.bpc_en, REG_CMP_EQ(c, LOG_BNR_EN, 1), 0x15004800, 0x00000001, 0, CAM_BNR_BPC_CON, BPC_EN)\
  CMD(a, b, c, d, e, bnr.bpc_tbl_en, REG_CMP_EQ(c, LOG_BNR_EN, 1), 0x15004800, 0x00000010, 4, CAM_BNR_BPC_CON, BPC_LUT_EN)\
  ...
  CMD(a, b, c, d, e, nsl2a.nsl2a_hrz_comp, REG_CMP_EQ(c, LOG_NSL2A_EN, 1), 0x15004F70, 0x00003FFF, 0, CAM_NSL2A_RZ, SL2_HRZ_COMP)\
  CMD(a, b, c, d, e, nsl2a.nsl2a_vrz_comp, REG_CMP_EQ(c, LOG_NSL2A_EN, 1), 0x15004F70, 0x3FFF0000, 16, CAM_NSL2A_RZ, SL2_VRZ_COMP)\
  CMD(a, b, c, d, e, nbc.anr_eny, REG_CMP_EQ(c, LOG_NBC_EN, 1), 0x15007A00, 0x00000002, 1, CAM_ANR_CON1, ANR1_ENY)\
  CMD(a, b, c, d, e, nbc.anr_enc, REG_CMP_EQ(c, LOG_NBC_EN, 1), 0x15007A00, 0x00000001, 0, CAM_ANR_CON1, ANR1_ENC)\
  CMD(a, b, c, d, e, nbc.anr_scale_mode, REG_CMP_EQ(c, LOG_NBC_EN, 1), 0x15007A00, 0x00000030, 4, CAM_ANR_CON1, ANR1_SCALE_MODE)\
...
typedef struct ISP_TPIPE_CONFIG_NSL2A_STRUCT
{
    int nsl2a_hrz_comp;
    int nsl2a_vrz_comp;
}ISP_TPIPE_CONFIG_NSL2A_STRUCT;
