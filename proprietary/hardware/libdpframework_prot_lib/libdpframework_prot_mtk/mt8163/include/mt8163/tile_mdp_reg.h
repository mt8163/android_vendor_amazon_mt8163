...
#define MDP_TILE_HW_REG_LUT(CMD, a, b, c, d, e) \
    ...
    CMD(a, b, c, d, e, int, enable_ISP,, CAMIN_EN,,,,,)\
    CMD(a, b, c, d, e, int, enable_MDP_RDMA0,, RDMA0_EN,,,,,)\
    CMD(a, b, c, d, e, int, enable_MDP_PRZ0,, PRZ0_EN,,,,,)\
    CMD(a, b, c, d, e, int, enable_MDP_PRZ1,, PRZ1_EN,,,,,)\
    CMD(a, b, c, d, e, int, enable_MDP_TDSHP0,, TDSHP0_EN,,,,,)\
    CMD(a, b, c, d, e, int, enable_MDP_WROT0,, WROT0_EN,,,,,)\
    CMD(a, b, c, d, e, int, enable_MDP_WDMA,, WDMA_EN,,,,,)\
    CMD(a, b, c, d, e, int, enable_MDP_CROP,, JPEGENC_EN,,,,,)\
    /* MUX - mout */\
    CMD(a, b, c, d, e, int, DISP_isp_mout_en, MMSYS_ISP_MOUT_EN, CAMIN_OUT,,,,,)\
    CMD(a, b, c, d, e, int, DISP_mdp_rdma0_mout_en, MMSYS_MDP_RDMA0_MOUT_EN, RDMA0_OUT,,,,,)\
    CMD(a, b, c, d, e, int, DISP_mdp_prz0_mout_en, MMSYS_MDP_PRZ0_MOUT_EN, PRZ0_OUT,,,,,)\
    CMD(a, b, c, d, e, int, DISP_mdp_prz1_mout_en, MMSYS_MDP_PRZ1_MOUT_EN, PRZ1_OUT,,,,,)\
    CMD(a, b, c, d, e, int, DISP_mdp_tdshp0_mout_en, MMSYS_MDP_TDSHP0_MOUT_EN, TDSHP0_OUT,,,,,)\
    /* MUX - sel in */\
    CMD(a, b, c, d, e, int, DISP_mdp_prz0_sel, MMSYS_MDP_PRZ0_SEL_IN, PRZ0_SEL,,,,,)\
    CMD(a, b, c, d, e, int, DISP_mdp_prz1_sel, MMSYS_MDP_PRZ1_SEL_IN, PRZ1_SEL,,,,,)\
    CMD(a, b, c, d, e, int, DISP_mdp_tdshp0_sel, MMSYS_MDP_TDSHP0_SEL_IN, TDSHP0_SEL,,,,,)\
    CMD(a, b, c, d, e, int, DISP_mdp_wdma_sel, MMSYS_MDP_WDMA_SEL_IN, WDMA_SEL,,,,,)\
    CMD(a, b, c, d, e, int, DISP_mdp_wrot0_sel, MMSYS_MDP_WROT0_SEL_IN, WROT0_SEL,,,,,)\
...
#define RSZ_LINE_BUFFER_1   (288)
#define RSZ_LINE_BUFFER_2   (RSZ_LINE_BUFFER_1 / 2)
#define TDSHP_TILE_WIDTH    (272)
#define WDMA_TILE_WIDTH     (256)
