...
#define PQ_PROT_LOGD(fmt, ...) __android_log_print(ANDROID_LOG_DEBUG, LOG_TAG, "[PQ_PROT] " fmt, ##__VA_ARGS__)
#define PQ_PROT_LOGE(fmt, ...) __android_log_print(ANDROID_LOG_ERROR, LOG_TAG, "[PQ_PROT] " fmt, ##__VA_ARGS__)
