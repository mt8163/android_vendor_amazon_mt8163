...
{
    { tCAMIN,       { tSCL0,    tSCL1,   tNone,   tNone, tNone },  ISP_MOUT_EN   },
    { tRDMA0,       { tSCL0,    tSCL1,   tWROT0,   tNone, tNone },  MDP_RDMA0_MOUT_EN  },
    { tSCL0,        { tWDMA,    tWROT0,  tTDSHP0, tSCL1, tNone },  MDP_PRZ0_MOUT_EN  },
    { tSCL1,        { tWDMA,    tWROT0,  tTDSHP0, tNone, tNone },  MDP_PRZ1_MOUT_EN  },
    { tTDSHP0,      { tWDMA,    tWROT0,  tNone,   tNone, tNone },  MDP_TDSHP_MOUT_EN },
};
...
const DpPathConnection::sel_t DpPathConnection::s_selInMap[SEL_IN_SIZE] =
{
    ...
    { tSCL1,    { tCAMIN,  tRDMA0, tSCL0,   tNone, tNone, tNone, tNone, tNone }, MDP_PRZ1_SEL_IN },
    { tTDSHP0,  { tSCL0,   tSCL1,  tNone,   tNone, tNone, tNone, tNone, tNone }, MDP_TDSHP_SEL_IN },
    { tWDMA,    { tSCL0,   tSCL1,  tTDSHP0, tNone, tNone, tNone, tNone, tNone }, MDP_WDMA_SEL_IN },
    { tWROT0,   { tSCL0,   tSCL1,  tTDSHP0, tRDMA0, tNone, tNone, tNone, tNone }, MDP_WROT0_SEL_IN },
};
