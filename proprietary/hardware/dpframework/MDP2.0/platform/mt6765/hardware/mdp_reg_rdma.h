...
#define MDP_RDMA_PROC_TRAC_CON_0        (ID_ADDR(m_identifier) + MDP_RDMA0_BASE + 0x0270)
#define MDP_RDMA_PROC_TRAC_CON_1        (ID_ADDR(m_identifier) + MDP_RDMA0_BASE + 0x0278)
#define MDP_RDMA_PROC_TRAC_CON_2        (ID_ADDR(m_identifier) + MDP_RDMA0_BASE + 0x0280)
...
#define MDP_RDMA_DMABUF_CON_3           (ID_ADDR(m_identifier) + MDP_RDMA0_BASE + 0x0290)
#define MDP_RDMA_DMAULTRA_CON_3         (ID_ADDR(m_identifier) + MDP_RDMA0_BASE + 0x0298)
...
// MASK
#define MDP_RDMA_EN_MASK                    (0x7FFFF1)
...
#define MDP_RDMA_SRC_CON_MASK               (0xFF13F7FF)
...
#define MDP_RDMA_TRANSFORM_0_MASK           (0xF010000)
...
#define MDP_RDMA_DMABUF_CON_0_MASK          (0x07FF007F)
#define MDP_RDMA_DMAULTRA_CON_0_MASK        (0xFFFFFFFF)
#define MDP_RDMA_DMABUF_CON_1_MASK          (0x077F003F)
#define MDP_RDMA_DMAULTRA_CON_1_MASK        (0x7F7F7F7F)
#define MDP_RDMA_DMABUF_CON_2_MASK          (0x073F003F)
#define MDP_RDMA_DMAULTRA_CON_2_MASK        (0x3F3F3F3F)
#define MDP_RDMA_PROC_TRAC_CON_0_MASK       (0x70000FFF)
#define MDP_RDMA_PROC_TRAC_CON_1_MASK       (0x0FFFFFF)
#define MDP_RDMA_PROC_TRAC_CON_2_MASK       (0x0FFFFFF)
#define MDP_RDMA_DMABUF_CON_3_MASK          (0x071F001F)
#define MDP_RDMA_DMAULTRA_CON_3_MASK        (0x1F1F1F1F)
