...
//#define MDP_RDMA_UFO_DEC_LEN_BASE_Y     (ID_ADDR(m_identifier) + MDP_RDMA0_BASE + 0x0F20)
//#define MDP_RDMA_UFO_DEC_LEN_BASE_C     (ID_ADDR(m_identifier) + MDP_RDMA0_BASE + 0x0F28)
...
#define MDP_RDMA_RESV_DUMMY_0           (ID_ADDR(m_identifier) + MDP_RDMA0_BASE + 0x0270)
...
#define MDP_FAKE_ISP_ADDR_0                  (MDP_RDMA0_BASE+0x0394)
#define MDP_FAKE_ISP_ADDR_1                  (MDP_RDMA0_BASE+0x0398)
#define MDP_FAKE_ISP_ADDR_2                  (MDP_RDMA0_BASE+0x039C)

#define MDP_RDMA0_EN                     (MDP_RDMA0_BASE + 0x0000)
#define MDP_RDMA0_RESET                  (MDP_RDMA0_BASE + 0x0008)
#define MDP_RDMA0_INTERRUPT_ENABLE       (MDP_RDMA0_BASE + 0x0010)
#define MDP_RDMA0_INTERRUPT_STATUS	    (MDP_RDMA0_BASE + 0x0018)
#define MDP_RDMA0_CON	                (MDP_RDMA0_BASE + 0x0020)
#define MDP_RDMA0_GMCIF_CON              (MDP_RDMA0_BASE + 0x0028)
#define MDP_RDMA0_SRC_CON                (MDP_RDMA0_BASE + 0x0030)
#define MDP_RDMA0_SRC_BASE_0             (MDP_RDMA0_BASE + 0x0F00)
#define MDP_RDMA0_SRC_BASE_1             (MDP_RDMA0_BASE + 0x0F08)
#define MDP_RDMA0_SRC_BASE_2             (MDP_RDMA0_BASE + 0x0F10)
#define MDP_RDMA0_UFO_DEC_LEN_BASE_Y      (MDP_RDMA0_BASE + 0x0F20)
#define MDP_RDMA0_UFO_DEC_LEN_BASE_C      (MDP_RDMA0_BASE + 0x0F28)
#define MDP_RDMA0_MF_BKGD_SIZE_IN_BYTE   (MDP_RDMA0_BASE + 0x0060)
#define MDP_RDMA0_MF_SRC_SIZE	        (MDP_RDMA0_BASE + 0x0070)
#define MDP_RDMA0_MF_CLIP_SIZE	        (MDP_RDMA0_BASE + 0x0078)
#define MDP_RDMA0_MF_OFFSET_1	        (MDP_RDMA0_BASE + 0x0080)
#define MDP_RDMA0_MF_PAR	                (MDP_RDMA0_BASE + 0x0088)
#define MDP_RDMA0_SF_BKGD_SIZE_IN_BYTE   (MDP_RDMA0_BASE + 0x0090)
#define MDP_RDMA0_SF_PAR                 (MDP_RDMA0_BASE + 0x00B8)
#define MDP_RDMA0_MB_DEPTH               (MDP_RDMA0_BASE + 0x00C0)
#define MDP_RDMA0_MB_BASE                (MDP_RDMA0_BASE + 0x00C8)
#define MDP_RDMA0_MB_CON                 (MDP_RDMA0_BASE + 0x00D0)
#define MDP_RDMA0_SB_DEPTH               (MDP_RDMA0_BASE + 0x00D8)
#define MDP_RDMA0_SB_BASE                (MDP_RDMA0_BASE + 0x00E0)
#define MDP_RDMA0_SB_CON                 (MDP_RDMA0_BASE + 0x00E8)
#define MDP_RDMA0_SRC_END_0              (MDP_RDMA0_BASE + 0X0100)
#define MDP_RDMA0_SRC_END_1              (MDP_RDMA0_BASE + 0X0108)
#define MDP_RDMA0_SRC_END_2              (MDP_RDMA0_BASE + 0X0110)
#define MDP_RDMA0_SRC_OFFSET_0           (MDP_RDMA0_BASE + 0x0118)
#define MDP_RDMA0_SRC_OFFSET_1           (MDP_RDMA0_BASE + 0x0120)
#define MDP_RDMA0_SRC_OFFSET_2           (MDP_RDMA0_BASE + 0x0128)
#define MDP_RDMA0_SRC_OFFSET_W_0         (MDP_RDMA0_BASE + 0x0130)
#define MDP_RDMA0_SRC_OFFSET_W_1         (MDP_RDMA0_BASE + 0x0138)
#define MDP_RDMA0_SRC_OFFSET_W_2         (MDP_RDMA0_BASE + 0x0140)
#define MDP_RDMA0_TRANSFORM_0            (MDP_RDMA0_BASE + 0x0200)
#define MDP_RDMA0_TRANSFORM_1            (MDP_RDMA0_BASE + 0x0208)
#define MDP_RDMA0_TRANSFORM_2            (MDP_RDMA0_BASE + 0x0210)
#define MDP_RDMA0_TRANSFORM_3            (MDP_RDMA0_BASE + 0x0218)
#define MDP_RDMA0_TRANSFORM_4            (MDP_RDMA0_BASE + 0x0220)
#define MDP_RDMA0_TRANSFORM_5            (MDP_RDMA0_BASE + 0x0228)
#define MDP_RDMA0_TRANSFORM_6            (MDP_RDMA0_BASE + 0x0230)
#define MDP_RDMA0_TRANSFORM_7            (MDP_RDMA0_BASE + 0x0238)
#define MDP_RDMA0_DMABUF_CON_0           (MDP_RDMA0_BASE + 0x0240)
#define MDP_RDMA0_DMAULTRA_CON_0         (MDP_RDMA0_BASE + 0x0248)
#define MDP_RDMA0_DMABUF_CON_1           (MDP_RDMA0_BASE + 0x0250)
#define MDP_RDMA0_DMAULTRA_CON_1         (MDP_RDMA0_BASE + 0x0258)
#define MDP_RDMA0_DMABUF_CON_2           (MDP_RDMA0_BASE + 0x0260)
#define MDP_RDMA0_DMAULTRA_CON_2         (MDP_RDMA0_BASE + 0x0268)
#define MDP_RDMA0_RESV_DUMMY_0           (MDP_RDMA0_BASE + 0x0270)
#define MDP_RDMA0_CHKS_EXTR              (MDP_RDMA0_BASE + 0x0300)
#define MDP_RDMA0_CHKS_INTW              (MDP_RDMA0_BASE + 0x0308)
#define MDP_RDMA0_CHKS_INTR              (MDP_RDMA0_BASE + 0x0310)
#define MDP_RDMA0_CHKS_ROTO              (MDP_RDMA0_BASE + 0x0318)
#define MDP_RDMA0_CHKS_SRIY              (MDP_RDMA0_BASE + 0x0320)
#define MDP_RDMA0_CHKS_SRIU              (MDP_RDMA0_BASE + 0x0328)
#define MDP_RDMA0_CHKS_SRIV              (MDP_RDMA0_BASE + 0x0330)
#define MDP_RDMA0_CHKS_SROY              (MDP_RDMA0_BASE + 0x0338)
#define MDP_RDMA0_CHKS_SROU              (MDP_RDMA0_BASE + 0x0340)
#define MDP_RDMA0_CHKS_SROV              (MDP_RDMA0_BASE + 0x0348)
#define MDP_RDMA0_CHKS_VUPI              (MDP_RDMA0_BASE + 0x0350)
#define MDP_RDMA0_CHKS_VUPO              (MDP_RDMA0_BASE + 0x0358)
#define MDP_RDMA0_DEBUG_CON              (MDP_RDMA0_BASE + 0x0380)
#define MDP_RDMA0_MON_STA_0              (MDP_RDMA0_BASE + 0x0400)
#define MDP_RDMA0_MON_STA_1              (MDP_RDMA0_BASE + 0x0408)
#define MDP_RDMA0_MON_STA_2              (MDP_RDMA0_BASE + 0x0410)
#define MDP_RDMA0_MON_STA_3              (MDP_RDMA0_BASE + 0x0418)
#define MDP_RDMA0_MON_STA_4              (MDP_RDMA0_BASE + 0x0420)
#define MDP_RDMA0_MON_STA_5              (MDP_RDMA0_BASE + 0x0428)
#define MDP_RDMA0_MON_STA_6              (MDP_RDMA0_BASE + 0x0430)
#define MDP_RDMA0_MON_STA_7              (MDP_RDMA0_BASE + 0x0438)
#define MDP_RDMA0_MON_STA_8              (MDP_RDMA0_BASE + 0x0440)
#define MDP_RDMA0_MON_STA_9              (MDP_RDMA0_BASE + 0x0448)
#define MDP_RDMA0_MON_STA_10             (MDP_RDMA0_BASE + 0x0450)
#define MDP_RDMA0_MON_STA_11             (MDP_RDMA0_BASE + 0x0458)
#define MDP_RDMA0_MON_STA_12             (MDP_RDMA0_BASE + 0x0460)
#define MDP_RDMA0_MON_STA_13             (MDP_RDMA0_BASE + 0x0468)
#define MDP_RDMA0_MON_STA_14             (MDP_RDMA0_BASE + 0x0470)
#define MDP_RDMA0_MON_STA_15             (MDP_RDMA0_BASE + 0x0478)
#define MDP_RDMA0_MON_STA_16             (MDP_RDMA0_BASE + 0x0480)
#define MDP_RDMA0_MON_STA_17             (MDP_RDMA0_BASE + 0x0488)
#define MDP_RDMA0_MON_STA_18             (MDP_RDMA0_BASE + 0x0490)
#define MDP_RDMA0_MON_STA_19             (MDP_RDMA0_BASE + 0x0498)
#define MDP_RDMA0_MON_STA_20             (MDP_RDMA0_BASE + 0x04a0)
#define MDP_RDMA0_MON_STA_21             (MDP_RDMA0_BASE + 0x04a8)
#define MDP_RDMA0_MON_STA_22             (MDP_RDMA0_BASE + 0x04b0)
...
#define MDP_RDMA_SRC_CON_MASK                (0xF113F7FF)
...
#define MDP_RDMA_TRANSFORM_0_MASK            (0x0F110777)
