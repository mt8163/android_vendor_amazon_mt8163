...
/*Jade New feature*/
#define MDP_DC_DBG_CFG_MAIN           ( MDP_TDSHP0_BASE + 0x250)
#define MDP_DC_WIN_X_MAIN             ( MDP_TDSHP0_BASE + 0x254)
#define MDP_DC_WIN_Y_MAIN             ( MDP_TDSHP0_BASE + 0x258)
#define MDP_DC_TWO_D_W1               ( MDP_TDSHP0_BASE + 0x25C)
#define MDP_DC_TWO_D_W1_RESULT_INIT   ( MDP_TDSHP0_BASE + 0x260)
#define MDP_DC_TWO_D_W1_RESULT        ( MDP_TDSHP0_BASE + 0x264)
