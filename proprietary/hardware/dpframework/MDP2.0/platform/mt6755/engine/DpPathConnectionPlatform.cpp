...
const DpPathConnection::mout_t DpPathConnection::s_moutMap[MOUT_MAP_SIZE] =
{
    ...
    { tCOLOR0,      { tWDMA,    tWROT0,  tNone,   tNone, tNone },  MMSYS_MDP_TDSHP0_MOUT_EN },
};
...
const DpPathConnection::sel_t DpPathConnection::s_selInMap[SEL_IN_SIZE] =
{
    ...
    { tWDMA,    { tSCL0,   tSCL1,  tCOLOR0, tNone, tNone, tNone, tNone, tNone }, MMSYS_MDP_WDMA_SEL_IN },
    { tWROT0,   { tSCL0,   tSCL1,  tCOLOR0, tNone, tNone, tNone, tNone, tNone }, MMSYS_MDP_WROT0_SEL_IN },
};
...
DP_STATUS_ENUM DpPathConnection::initTilePath(struct TILE_PARAM_STRUCT *p_tile_param)
{
    ...
    for (index = 0; index < MOUT_NUM; index++)
    {
        ...
        case tCOLOR0:   ptr_tile_reg_map->TDSHP0_OUT    = m_mOutInfo[index]; break;
        default:        assert(0);
        }
    }
