...
private:
    static DpColorMatrix RGB_TO_BT601;
    static DpColorMatrix RGB_TO_JPEG;
...
DpColorMatrix DpEngine_WROT::RGB_TO_BT601 = DpColorMatrix(
     0.256788,  0.504129,  0.097906,
    -0.148223, -0.290993,  0.439216,
     0.439216, -0.367788, -0.071427);

DpColorMatrix DpEngine_WROT::RGB_TO_JPEG = DpColorMatrix(
...
DP_STATUS_ENUM DpEngine_WROT::onConfigTile(DpCommand &command)
{
    ...
    {
        // Target Y offset
        WROT_y_ofst_adr = m_outTileYTop * m_targetPitchY + m_outTileXLeft * m_bytesPerPixelY;

        // Target U offset
        WROT_c_ofst_adr = (m_outTileYTop  >> m_verRightShiftUV) * m_targetPitchUV +
                          (m_outTileXLeft >> m_horRightShiftUV) * m_bytesPerPixelUV;
    ...
    {
        // Target Y offset
        WROT_y_ofst_adr = m_outTileYTop * m_targetPitchY + (m_outFrameWidth - m_outTileXLeft) * m_bytesPerPixelY - 1;

        // Target U offset
        WROT_c_ofst_adr = (m_outTileYTop >> m_verRightShiftUV) * m_targetPitchUV +
                          ((m_outFrameWidth - m_outTileXLeft) >> m_horRightShiftUV) * m_bytesPerPixelUV - 1;
    ...
    {
        // Target Y offset
        WROT_y_ofst_adr = m_outTileXLeft * m_targetPitchY + (m_outFrameHeight - m_outTileYTop) * m_bytesPerPixelY - 1;

        // Target U offset
        WROT_c_ofst_adr = (m_outTileXLeft >> m_verRightShiftUV) * m_targetPitchUV +
                          ((m_outFrameHeight - m_outTileYTop) >> m_horRightShiftUV) * m_bytesPerPixelUV - 1;
    ...
    {
        // Target Y offset
        WROT_y_ofst_adr = m_outTileXLeft * m_targetPitchY + m_outTileYTop * m_bytesPerPixelY;

        // Target U offset
        WROT_c_ofst_adr = (m_outTileXLeft >> m_verRightShiftUV) * m_targetPitchUV +
                          (m_outTileYTop >> m_horRightShiftUV) * m_bytesPerPixelUV;
    ...
    else if ((180 == m_rotationAngle) && (false == m_flipHorizontal))
    {
        ...
        WROT_y_ofst_adr = (m_outFrameHeight - m_outTileYTop - 1) * m_targetPitchY +
                          (m_outFrameWidth - m_outTileXLeft) * m_bytesPerPixelY - 1;
    ...
    {
        // Target Y offset
        WROT_y_ofst_adr = (m_outFrameHeight - m_outTileYTop - 1) * m_targetPitchY + m_outTileXLeft * m_bytesPerPixelY;
    ...
    {
        // Target Y offset
        WROT_y_ofst_adr = (m_outFrameWidth - m_outTileXLeft - 1) * m_targetPitchY + m_outTileYTop * m_bytesPerPixelY;
    ...
    else if ((270 == m_rotationAngle) && (true == m_flipHorizontal))
    {
        ...
        WROT_y_ofst_adr = (m_outFrameWidth - m_outTileXLeft - 1) * m_targetPitchY +
                          (m_outFrameHeight - m_outTileYTop) * m_bytesPerPixelY - 1;
...
DP_STATUS_ENUM DpEngine_WROT::onUpdatePMQOS(uint32_t& totalPixel, uint32_t& totalDataSzie, struct timeval& endtime)
{
    uint32_t        data = 0;
    uint32_t        plane = 0;
