...
DpColorMatrix DpEngine_WDMA::RGB_TO_BT601 = DpColorMatrix(
     0.256788,  0.504129,  0.097906,
    -0.148223, -0.290993,  0.439216,
     0.439216, -0.367788, -0.071427);

DpColorMatrix DpEngine_WDMA::RGB_TO_JPEG = DpColorMatrix(
...
DP_STATUS_ENUM DpEngine_WDMA::onUpdatePMQOS(uint32_t& totalPixel, uint32_t& totalDataSzie, struct timeval& endtime)
{
    uint32_t        data = 0;
    uint32_t        plane = 0;
