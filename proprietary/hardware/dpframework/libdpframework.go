...
func init() {
	...
	android.RegisterModuleType("mtk_libdpframework_mtk_defaults", mtkLibdpFrameworkMtkDefaultsFactory)
}
...
func mtkLibdpFrameworkMtkDefaultsFactory() android.Module {
	module := cc.DefaultsFactory()
	android.AddLoadHook(module, func(ctx android.LoadHookContext) { mtkLibdpFrameworkLoadHook(ctx, false) })
	return module
}
...
func mtkLibdpFrameworkLoadHook(ctx android.LoadHookContext, vendor bool) {
	...
	p := &props{}
	targetBoardPlatform := mediatek.GetFeature("TARGET_BOARD_PLATFORM")
	...
	case "mt8163":
		mdpPlatformFolder = "mt8163"
	default:
		mdpPlatformFolder = "mt8163"
	}
	if mediatek.GetFeature("BUILD_MTK_LDVT") == "true" {
		p.Cflags = append(p.Cflags, "-DUSING_MTK_LDVT")
	}
	if mediatek.GetFeature("MTK_M4U_SUPPORT") == "yes" {
	...
	switch targetBoardPlatform {
	case "mt6755", "mt6757", "mt6750", "mt6797", "mt6799", "mt6759", "mt6758", "mt6763", "mt6739", "mt6775", "mt6771", "mt6765", "mt6761", "mt3967", "mt6779":
	...
	switch targetBoardPlatform {
	case "mt6755", "mt6757", "mt6750", "mt6797", "mt6799", "mt6758", "mt6763", "mt6759", "mt6739", "mt6775", "mt6771", "mt6765", "mt6761", "mt3967", "mt6779":
	...
	switch targetBoardPlatform {
	case "mt6759", "mt6758", "mt6763", "mt6775", "mt6771", "mt6765", "mt6761", "mt3967", "mt6779":
		p.Srcs = append(p.Srcs, "MDP2.0/engine/DpEngine_MDPSOUT.cpp")
	}
	switch targetBoardPlatform {
	case "mt6775", "mt6771", "mt3967":
		p.Srcs = append(p.Srcs, "MDP2.0/engine/DpEngine_CCORR.cpp")
	}
	switch targetBoardPlatform {
	case "mt6775", "mt6771", "mt3967", "mt6779":
	...
	switch targetBoardPlatform {
	case "mt6799", "mt6775", "mt6771", "mt3967":
	...
	case "mt6799", "mt6763", "mt6758", "mt6775", "mt6771", "mt6765", "mt6761", "mt3967", "mt6779":
		ipRszFolder = "rsz6799"
		p.Cflags = append(p.Cflags, "-DRSZ_2_0")
	...
	switch targetBoardPlatform {
	case "mt6757", "mt6799", "mt6758", "mt6763", "mt6739", "mt6775", "mt6771", "mt6765", "mt6761", "mt3967", "mt6779":
	...
	case "mt6739", "mt6797", "mt6757", "mt6759", "mt6758", "mt6763", "mt6775", "mt6771", "mt6765", "mt3967", "mt6779", "mt8163", "mt8167", "mt8173":
		ipTileIspFolder = strings.Replace(targetBoardPlatform, "mt", "isp", 1)
	default:
		ipTileIspFolder = "isp8163"
	}
	...
	switch targetBoardPlatform {
	case "mt6739", "mt6755", "mt6757", "mt6750", "mt6797", "mt6799", "mt6759", "mt6758", "mt6763", "mt6775", "mt6771", "mt6765", "mt6761", "mt3967", "mt6779":
		p.Cflags = append(p.Cflags, "-DTDSHP_1_1")
	}
	switch targetBoardPlatform {
	case "mt6797", "mt6799", "mt6763", "mt6758", "mt6775", "mt6771", "mt6765", "mt6761", "mt3967", "mt6779":
		p.Cflags = append(p.Cflags, "-DTDSHP_2_0")
	}
	switch targetBoardPlatform {
	case "mt6775", "mt6771", "mt6765", "mt6761", "mt3967", "mt6779":
	...
	switch targetBoardPlatform {
	case "mt6771", "mt6775", "mt3967", "mt6779":
	...
	} else if mediatek.GetFeature("MTK_BASIC_PACKAGE") == "yes" {
		mdpOpenPqConfig = false
	} else {
	...
	if mdpOpenPqConfig {
		...
		case "mt6799":
			supportHdr = true
			p.Cflags = append(p.Cflags, "-DHDR_IN_RDMA")
		...
		switch targetBoardPlatform {
		case "mt6797", "mt6799", "mt6759", "mt6758", "mt6763", "mt6739", "mt6775", "mt6771", "mt6765", "mt6761", "mt3967", "mt6779":
		...
		switch targetBoardPlatform {
		case "mt6755", "mt6757", "mt6750", "mt6797", "mt6799", "mt6759", "mt6758", "mt6763", "mt6775", "mt6771", "mt6765", "mt6761", "mt3967", "mt6779":
		...
		case "mt6755", "mt6757", "mt6750", "mt6797", "mt6799", "mt6759", "mt6758", "mt6763", "mt6775", "mt6771", "mt6765", "mt6761", "mt3967", "mt6779":
			...
			switch targetBoardPlatform {
			case "mt6797", "mt6757", "mt6799", "mt6763", "mt6758", "mt6775", "mt6771", "mt3967", "mt6779":
				p.Cflags = append(p.Cflags, "-DCOLOR_2_1")
			}
			switch targetBoardPlatform {
			case "mt6757", "mt6799", "mt6763", "mt6758", "mt6775", "mt6771", "mt3967", "mt6779":
	...
	//}
	// Venc Modify -
	mtkPlatformDir := strings.ToLower(mediatek.GetFeature("MTK_PLATFORM"))
	switch targetBoardPlatform {
	case "mt6735", "mt6737t", "mt6735m", "mt6737m", "mt6753", "mt6570", "mt6580", "mt6752", "mt6755", "mt6757", "mt6750", "mt6797", "mt6799", "mt6759", "mt6758", "mt6763", "mt8163", "mt8167", "mt8173", "mt6775", "mt6771", "mt6765", "mt6761", "mt3967", "mt6779":
	...
	if mediatek.GetFeature("BUILD_MTK_LDVT") == "true" {
		p.Include_dirs = append(p.Include_dirs, filepath.Join(mediatek.MtkPathSource, "external/ldvt/include"))
		p.Include_dirs = append(p.Include_dirs, filepath.Join(mediatek.MtkPathSource, "hardware/camera/inc/drv"))
	}
	if mediatek.GetFeature("BUILD_MTK_LDVT") == "true" {
		p.Whole_static_libs = append(p.Whole_static_libs, "libuvvf")
	}
	if mediatek.GetFeature("MTK_MIRAVISION_SUPPORT") == "true" {
...
func isLegacy(targetBoardPlatform string) bool {
	switch targetBoardPlatform {
	case "mt6757", "mt6797", "mt6799", "mt6759", "mt6763", "mt6758", "mt3886", "elbrus", "mt6775", "mt6771", "mt6765", "mt3967", "mt6779":
		return false
	default:
		return true
	}
