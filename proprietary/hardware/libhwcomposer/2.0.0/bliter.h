...
public:
    ...
    // cancelLayers in BliterHandler is used to cancel mm layers of job
...
private:
    ...
    void releaseFence(int fd, int sync_marker, int ovl_in);
    ...
    // invalidateS3d() is used to ask DpFramework to do S3D bliting
    status_t invalidateS3d(
