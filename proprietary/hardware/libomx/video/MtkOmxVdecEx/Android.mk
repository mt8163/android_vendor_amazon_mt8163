...
LOCAL_SRC_FILES += MtkOmxVdecMJC.cpp
...
LOCAL_C_INCLUDES:= \
        ...
        $(TOP)/$(MTK_ROOT)/hardware/libomx/video/MtkMJCFramework/ \
        $(TOP)/$(MTK_ROOT)/hardware/libmjc/common \
...
LOCAL_C_INCLUDES += $(TOP)/$(MTK_PATH_SOURCE)/hardware/imagecodec/inc
LOCAL_C_INCLUDES += $(TOP)/$(MTK_ROOT)/hardware/jpeg/include/mhal/
