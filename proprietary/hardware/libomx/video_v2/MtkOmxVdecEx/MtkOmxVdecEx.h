...
#define MAX_COLORCONVERT_OUTPUTBUFFER_COUNT 8   // max dpb / 2
...
#define MIN_UNDEQUEUED_BUFS 3 // Should be identical to ACodec's one
// mNativeWindow->query(
// mNativeWindow.get(), NATIVE_WINDOW_MIN_UNDEQUEUED_BUFFERS,
// (int *)minUndequeuedBuffers)
#endif
...
//VDEC MTK In-house lib & api names
#define MTK_H264_SEC_VDEC_IN_HOUSE_LIB_NAME "lib_uree_mtk_video_secure_al.so"
#define MTK_HEVC_SEC_VDEC_IN_HOUSE_LIB_NAME "lib_uree_mtk_video_secure_al.so"  //HEVC.SEC.M0
#define MTK_H264_SEC_VDEC_IN_HOUSE_INIT_NAME "MtkVideoSecureMemAllocatorInit"
#define MTK_H264_SEC_VDEC_IN_HOUSE_DEINIT_NAME "MtkVideoSecureMemAllocatorDeInit"
#define MTK_H264_SEC_VDEC_IN_HOUSE_ALLOCATE_SECURE_FRAME_BUFFER "MtkVideoAllocateSecureFrameBuffer"
#define MTK_H264_SEC_VDEC_IN_HOUSE_REGISTER_SHARED_MEMORY "MtkVideoRegisterSharedMemory"
#define MTK_H264_SEC_VDEC_IN_HOUSE_ALLOCATE_SECURE_BUFFER "MtkVideoAllocateSecureBuffer"
#define MTK_H264_SEC_VDEC_IN_HOUSE_FREE_SECURE_BUFFER "MtkVideoFreeSecureBuffer"

//VDEC MTK In-house function pointer types
typedef MTK_SECURE_AL_RESULT MtkVideoSecureMemAllocatorInit_Ptr();
...
typedef unsigned long MtkVideoRegisterSharedMemory_Ptr(void *, int);
...
#define MTK_VDEC_VP9_DEFAULT_INPUT_BUFFER_SIZE_4K   12*1024*1024
...
class MtkOmxVdec : public MtkOmxBase
{
    public:
        ...
        OMX_BUFFERHEADERTYPE *GetDisplayBuffer(OMX_BOOL bGetResolution = OMX_FALSE, VDEC_DRV_FRAMEBUF_T **ppFrameBuf = NULL, OMX_TICKS* timestamp = NULL, OMX_S32* isLastFrame = NULL);
        OMX_BOOL InitVideoDecodeHW(OMX_S32 *aWidth, OMX_S32 *aHeight, OMX_S32 *aAspectRatioWidth, OMX_S32 *aAspectRatioHeight, OMX_U8 *aBuffer, OMX_U32 *aSize, OMX_BUFFERHEADERTYPE *pInputBuf);
        ...
        OMX_BOOL initCodec_PortReconfig(OMX_BUFFERHEADERTYPE *pInputBuf, OMX_S32 iDisplayWidth, OMX_S32 iDisplayHeight, OMX_S32 iAspectRatioWidth, OMX_S32 iAspectRatioHeight, OMX_BOOL *needEarlyExit);
        ...
        OMX_BOOL isUFOSupported(VAL_BOOL_T *UFOSupport);
    ...
    // + GetParameter
        ...
        void HandleAllInit(OMX_INDEXTYPE nParamIndex, OMX_PTR pCompParam);
    // - GetParameter
        ...
        VAL_UINT32_T mColorConvertDstBufferCount;
        VAL_UINT32_T mColorConvertDstBufferHdr[MAX_COLORCONVERT_OUTPUTBUFFER_COUNT];
        ...
        void *mH264SecVdecInHouseLib;
        void *mHEVCSecVdecInHouseLib; //HEVC.SEC.M0
        void FdDebugDump();

        OMX_BOOL ConvertFrameToYV12(FrmBufStruct *pFrameBuf, FrmBufStruct *pFrameBufOut, OMX_BOOL bGetResolution);
        ...
        int mConvertCmdPipe[2];      // commands from convert
