...
ifneq (,$(filter $(strip $(TARGET_BOARD_PLATFORM)), mt6757 mt6763 mt6758 mt6771 mt6775 mt3967))
...
else ifneq (,$(filter $(strip $(TARGET_BOARD_PLATFORM)), mt6771 mt6775 mt6765 mt6761 mt3967))
...
LOCAL_MODULE := vendor.mediatek.hardware.pq@2.2-impl
